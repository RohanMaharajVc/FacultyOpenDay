...
const Humanities = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-humanities-light to-orange-50">
      <div className="container mx-auto px-4 py-12">
        {/* Header */}
        <div className="text-center mb-12">
          <h1 className="text-5xl font-bold text-humanities-dark mb-4">{faculty.name}</h1>
